...
### Fixed
- Google SSO login button now works correctly (was blocked by CORS when using Inertia Link)
...
### Fixed
- Fixed error when viewing the Utility Accounts admin page
...
### Changed
- Improved frontend routing reliability and maintainability
...
### Changed
- Improved authentication and user management reliability
...
### Changed
- Property detail page now loads units with server-side pagination for improved performance
